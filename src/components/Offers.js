    ...
    >
        ...
        >
          ...
          {!isUKR ? (
            <p className="lead">
              ...
              will learn at our own pace, and practice using our acquired
              knowledge in our speech.
              <br />
              The first 6 topics are simpler and will take 7 weeks each.
              <br />
              The next 6 topics are more complex, and will take 12 weeks.
            </p>
          ) : (
            <p className="lead">
              Загалом у курсі 12 тем. Ви працюєте з викладачем та послідовно опрацьовуєте теми. Найважливішим принципом наших занять є саме індивідуальний підхід, тому ми нікуди не спішимо, а рухаємось у вашому темпі, щоб ви точно могли використовувати набуті знання у мовленні.
              <br />
              Перші 6 тем менш складні та обʼємні. Одна тема розрахована приблизно на 7 занять. Наступні 6 тем складніші та обширніші. Одна тема розрахована
              <br />
              приблизно на 12 занять.
            </p>
          )}
        </div>
      ...
      <div className="row featurette">
        ...
        >
          ...
          <p className="lead">
            We will cover 12 topics. You will receive topics sequentially, and
            have unlimited time to finish a topic.
            <br />
            There will be a practical task at the end of each topic, which you
            must solve and send to us.
            <br />
            You will receive FEEDBACK (How can we improve, what needs more
            attention) and then access to the next topic.
            <br />
            The first 6 topics are simpler and will take 5 classes each. Price -
            750 UAH per topic <br />
            The next 6 topics are more complex, and will take 10 classes. Price
            - 1450 UAH per topic{" "}
          </p>
        </div>
      ...
      <div className="row featurette">
        ...
        >
          <h2 className="featurette-heading fw-normal lh-1 mb-4">
            Topic One<span className="text-body-secondary">.</span>
          </h2>
          <p className="lead">
            ...
            Phrases and exercises for practising acquaintances.
          </p>
        </div>
        <div className="col-md-5">
          <img
      ...
      <div className="row featurette">
        ...
        >
          <h2 className="featurette-heading fw-normal lh-1">
            Topic Nine<span className="text-body-secondary">.</span>
          </h2>
          <p className="lead">
            Modal verbs
            <br />
            ...
            Shopping - vocabulary and adjectives to describe clothes
            <br />
